 ...
 * @author Cam Patten
 */
class Adapter(private var items: MutableList<com.hotstuffkotlin.models.Item>): RecyclerView.Adapter<Adapter.ViewHolder>() {
     ...
     * @author Cam Patten
     */
    fun searchInsert(insertPosition: Int, updatedItemsArray: ArrayList<com.hotstuffkotlin.models.Item>) {
