package com.hotstuffkotlin.ui.home
...
import com.hotstuffkotlin.databinding.FragmentHomeBinding
import com.hotstuffkotlin.ui.onboard.OnboardActivity
import com.hotstuffkotlin.utils.ChartMarker
...
//        DatabaseHelper(context).upgradeTables() // TEMP FUNCTION
        ...
        catBarDataSet.setColors(com.hotstuffkotlin.utils.ThemeHelper.CHART_THEME, 255)
        ...
        roomBarDataSet.setColors(com.hotstuffkotlin.utils.ThemeHelper.CHART_THEME, 255)
