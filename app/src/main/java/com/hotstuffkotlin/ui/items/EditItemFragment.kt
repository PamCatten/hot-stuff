package com.hotstuffkotlin.ui.items
...
import com.hotstuffkotlin.databinding.FragmentEditItemBinding
import com.hotstuffkotlin.models.Item
import com.hotstuffkotlin.ui.create.CreateItemFragment
...
class EditItemFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        val takePicture = registerForActivityResult(ActivityResultContracts.TakePicture()) {
            isSaved -> if (isSaved) {
                ...
                MediaScannerConnection.scanFile(context, arrayOf(imageFile!!.path), arrayOf(
                    com.hotstuffkotlin.ui.create.CreateItemFragment.SELECT_MIME_TYPE), null)
            }
        }
        ...
        selectButton?.setOnClickListener {
            val requestedPermission = com.hotstuffkotlin.ui.create.CreateItemFragment.ACCESS_PERMISSION
            val checkSelfPermission = ContextCompat.checkSelfPermission(requireActivity(), requestedPermission)
            if (checkSelfPermission == PackageManager.PERMISSION_GRANTED) {
                try {
                    selectPicture.launch(arrayOf(com.hotstuffkotlin.ui.create.CreateItemFragment.SELECT_INPUT_TYPE))
                } catch (e: Exception) {
                    e.printStackTrace()
                    Toast.makeText(context, "Error: $e", Toast.LENGTH_SHORT).show()
                }
                ...
                ActivityCompat.requestPermissions(requireActivity(), arrayOf(requestedPermission),
                    com.hotstuffkotlin.ui.create.CreateItemFragment.PERMISSION_REQUEST_CODE
                )
        ...
        saveButton?.setOnClickListener {
            fun resetForm() {
                val item = com.hotstuffkotlin.models.Item()
                item.id = id
//                item.buildingId =
